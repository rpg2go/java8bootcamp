...
public abstract class Good implements Product, Comparable<Good> {
	...
	public static List<Good> catalog;
	...
	public int compareTo(Good g) {
		...
		if (getModelNumber() <  g.getModelNumber()) {
			return -1;
		}
		else if (getModelNumber() >  g.getModelNumber()) {
			return 1;
		} 
		else 
			return 0;
	...
	public static Set<Good> getFlammableList() {
		Set<Good> flammable = new HashSet<Good>();
		
		Iterator<Good> it = catalog.iterator();
