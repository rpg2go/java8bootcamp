package com.acme.ch15.collections.test;

import java.util.Iterator;
import java.util.Set;

import com.acme.ch15.collections.domain.Good;
import com.acme.ch15.collections.domain.Liquid;
import com.acme.ch15.collections.domain.UnitOfMeasureType;
...
public class TestGood {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------");
		Iterator it = Good.getCatalog().iterator();
		int i = 0;
		while (it.hasNext()){
		...
		System.out.println("------------------------------------------");
		Set flamableHashSet = Good.getFlammableList();
	 ...
	 * @param hashSet
	 */
	private static void removeObject(Good good, Set hashSet) {
	 ...
	 * @param hashSet
	 */
	private static void addObject(Good good, Set hashSet) {
		if (!hashSet.contains(good)) {
